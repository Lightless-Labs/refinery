...
Future upstream divergence expansion (see TODO 018):
- Prompt reframing — each model creates a strategically different version of the initial prompt; all models work the original plus all variations (`n(n+1)` lineages)
- Domain collisions — Open Collider-style structurally distant domains injected as isolated brief × domain lineages
